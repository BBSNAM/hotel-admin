...
public class OrderProductDetailService{
    ...
    public List<OrderProductDetail> selectOrderProductByOrderId(Integer orderId) {
        List<OrderProductDetail> orderProductDetails = orderProductDetailMapper.selectOrderProductByProType(orderId);
        List<OrderProductDetail> orderProductDetails2 = orderProductDetailMapper.selectOrderProductByOrderId(orderId);
        if(orderProductDetails != null && orderProductDetails2 != null) {
            orderProductDetails.addAll(orderProductDetails2);
        }
