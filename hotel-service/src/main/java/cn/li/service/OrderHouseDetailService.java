...
public class OrderHouseDetailService{
     ...
     * @throws Exception
     */
    public Map<String, Object> houseRenew(String endDate,Integer orderId,Integer day,List<OrderHouseDetail> houseOrders){
...
//            System.out.println("success=====================："+param.getClass()); // Object:Object
...
//        List<OrderHouseDetail> houseDetails = JSONObject.parseArray(array.toJSONString(),OrderHouseDetail.class);
            ...
            for (OrderHouseDetail houseDetail:houseOrders) {
                //修改订单详情的价格
