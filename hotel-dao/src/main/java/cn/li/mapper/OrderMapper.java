...
public interface OrderMapper {
    ...
    Integer selectAllCount(@Param("orderCode") String orderCode, @Param("clientName") String clientName, @Param("orderStatus") Integer orderStatus);
    ...
    Integer selectAllProductCount(@Param("orderCode") String orderCode);
